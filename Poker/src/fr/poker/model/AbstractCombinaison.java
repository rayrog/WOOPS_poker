...
public abstract class AbstractCombinaison implements Comparable<AbstractCombinaison> {
	...
	/* D�fini dans les classes filles */
	private String nom;
	...
	/*
	 * Compte le nombre de fois qu'une valeur est pr�sente dans une list de
	 * cartes
	 */
	...
	/*
	 * Compare les kikers de deux combinaisons; retourne 0 si kikers �gaux;
	 * retourne un negatif si les kikers sont inf�rieurs aux kikers de l'objet c
	 */
